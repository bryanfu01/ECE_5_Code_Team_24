...
L298NX2 DriveMotors(  42, 41, 40,      37, 39, 38); // Digital Pins on Arduino
//                 ENA, IN1, IN2, ENB, IN3, IN4

//Set Initial Speed of Motors
int speed = 125; // Speed inputs to motors go from 0 to 255
...
void loop() {
  ...
  runMotorAtSpeed(LEFT, -1*speed);
  runMotorAtSpeed(RIGHT, -1*speed);
